...
describe Sunspot::SessionProxy::MasterSlaveSessionProxy do
  ...
  {
    :master_session => Sunspot::Session.public_instance_methods(false) - [:search, 'search', :new_search, 'new_search', :config, 'config', :more_like_this, 'more_like_this'],
    :slave_session => [:search, :new_search, :more_like_this]

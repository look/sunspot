...
module Sunspot
  module SessionProxy
    ...
    class ThreadLocalSessionProxy < AbstractSessionProxy
      ...
      delegate :batch, :commit, :commit_if_delete_dirty, :commit_if_dirty, :delete_dirty?, :dirty?, :index, :index!, :new_search, :remove, :remove!, :remove_all, :remove_all!, :remove_by_id, :remove_by_id!, :search, :more_like_this, :to => :session
